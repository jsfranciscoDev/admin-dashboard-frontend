...
<template>
    <div class="p-20">
      <DefaultAuthCard subtitle="Lorem ipsum dolor sit amet" title="Sign In">
        <form  @submit.prevent="handleLogin">

          <InputGroup label="Email" type="email" placeholder="Enter your email" v-model="auth.user.email"  />
      

          <InputGroup label="Password" type="password" placeholder="6+ Characters, 1 Capital letter" v-model="auth.user.password" />
